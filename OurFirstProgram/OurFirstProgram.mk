...
ProjectPath            :=C:/Users/HomePC/Workspaces/Workspace2/OurFirstProgram
IntermediateDirectory  :=../build-$(WorkspaceConfiguration)/OurFirstProgram
...
$(IntermediateDirectory)/test.c$(ObjectSuffix): test.c $(IntermediateDirectory)/test.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/HomePC/Workspaces/Workspace2/OurFirstProgram/test.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/test.c$(ObjectSuffix) $(IncludePath)
